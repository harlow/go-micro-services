...
// 	protoc        v3.15.8
// source: internal/proto/geo/geo.proto
...
func (x *Request) Reset() {
	*x = Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_proto_geo_geo_proto_msgTypes[0]
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_internal_proto_geo_geo_proto_rawDescGZIP(), []int{0}
}
...
func (x *Result) Reset() {
	*x = Result{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_proto_geo_geo_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_internal_proto_geo_geo_proto_rawDescGZIP(), []int{1}
}
...
var File_internal_proto_geo_geo_proto protoreflect.FileDescriptor

var file_internal_proto_geo_geo_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x67, 0x65, 0x6f, 0x2f, 0x67, 0x65, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03,
	...
	0x73, 0x75, 0x6c, 0x74, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_internal_proto_geo_geo_proto_rawDescOnce sync.Once
	file_internal_proto_geo_geo_proto_rawDescData = file_internal_proto_geo_geo_proto_rawDesc
)

func file_internal_proto_geo_geo_proto_rawDescGZIP() []byte {
	file_internal_proto_geo_geo_proto_rawDescOnce.Do(func() {
		file_internal_proto_geo_geo_proto_rawDescData = protoimpl.X.CompressGZIP(file_internal_proto_geo_geo_proto_rawDescData)
	})
	return file_internal_proto_geo_geo_proto_rawDescData
}

var file_internal_proto_geo_geo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_proto_geo_geo_proto_goTypes = []interface{}{
	(*Request)(nil), // 0: geo.Request
	(*Result)(nil),  // 1: geo.Result
}
var file_internal_proto_geo_geo_proto_depIdxs = []int32{
...
func init() { file_internal_proto_geo_geo_proto_init() }
func file_internal_proto_geo_geo_proto_init() {
	if File_internal_proto_geo_geo_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_internal_proto_geo_geo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_proto_geo_geo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Result); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internal_proto_geo_geo_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_proto_geo_geo_proto_goTypes,
		DependencyIndexes: file_internal_proto_geo_geo_proto_depIdxs,
		MessageInfos:      file_internal_proto_geo_geo_proto_msgTypes,
	}.Build()
	File_internal_proto_geo_geo_proto = out.File
	file_internal_proto_geo_geo_proto_rawDesc = nil
	file_internal_proto_geo_geo_proto_goTypes = nil
	file_internal_proto_geo_geo_proto_depIdxs = nil
}
...
var _Geo_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/proto/geo/geo.proto",
}
